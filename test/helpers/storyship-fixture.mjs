...
export function makeStoryshipEventInput({
  constitutionId,
  sourceCut = [],
  voyageId = 'storyship-voyage-000',
  eventSeq = 1,
  eventType = 'voyage-created',
  branchId = 'branch-root',
  parentStateIds = [],
  actor = { owning_world: 'human', actor_id: 'operator-000', role: 'operator' },
  occurredAtSourceRaw = null,
  observedAt = '2026-08-24T12:00:01.000Z',
  recordedAt = '2026-08-24T12:00:02.000Z',
  payload = {},
  realityEffects = [],
  narrativeInterpretations = [],
  manifestEffects = [],
  uncertainty = [],
  authority = { owning_world: 'storyship', scope: 'fixture-only' },
  previousReceiptIds = [],
} = {}) {
  return {
